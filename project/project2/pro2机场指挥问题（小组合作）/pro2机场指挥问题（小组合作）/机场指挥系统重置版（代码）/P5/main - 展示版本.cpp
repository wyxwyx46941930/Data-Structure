...
LRESULT WINAPI WinProc(HWND hWnd,UINT Msg,WPARAM wParam,LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		//本例中是单线、水平居中和竖直居中。
		DrawText(hDC,"P5机场调度完成，请在out.txt中查看结果",-1,&rect,DT_SINGLELINE|DT_CENTER|DT_VCENTER);
		//EndPaint就是做些收尾的工作了。
		EndPaint(hWnd,&paint);
		break;
...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nShowCmd) {
    ...
    hWnd = CreateWindowEx(WS_EX_CLIENTEDGE,cName,"P5版本，单跑道，燃油耗尽的飞机可紧急降落",WS_OVERLAPPEDWINDOW,
