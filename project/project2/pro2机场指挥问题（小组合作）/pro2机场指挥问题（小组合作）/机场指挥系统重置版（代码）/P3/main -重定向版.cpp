...
LRESULT WINAPI WinProc(HWND hWnd,UINT Msg,WPARAM wParam,LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		//本例中是单线、水平居中和竖直居中。
		DrawText(hDC,"P3飞机调度完成，请在out.txt中查看结果",-1,&rect,DT_SINGLELINE|DT_CENTER|DT_VCENTER);
		//EndPaint就是做些收尾的工作了。
		EndPaint(hWnd,&paint);
		break;
...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nShowCmd) {
    ...
    hWnd = CreateWindowEx(WS_EX_CLIENTEDGE,cName,"P3两条跑道分别负责起飞降落紧急时两条都可以处理降落的版本",WS_OVERLAPPEDWINDOW,
